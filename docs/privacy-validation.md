...
```powershell
pwsh -NoProfile -File $env:PUBLIC_SURFACE_VALIDATOR -CandidateRoot . -SurfaceId genai-case-studies -DenylistPath $env:CASE_BOUNDARY_DENYLIST -ApprovalManifestPath $env:PUBLIC_APPROVAL_MANIFEST -FailClosed
```
