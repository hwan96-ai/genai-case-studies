...
> 공개 상태(2026-06-28): 공개 소스 저장소는 연결하지 않습니다. 쇼케이스의 설명·배포 표시는 이 비공개 구현의 공개 코드나 독립 검증 자료를 뜻하지 않습니다. owner가 별도 공개 패키지를 승인하면 그때 링크와 검증 범위를 함께 추가합니다.
